...
{
    [SerializeField] private float _magneticRange = 2f, _magneticPower = 1f;
    ...
    {
        Collider2D[] resources = Physics2D.OverlapCircleAll(transform.position, _magneticRange, _itemLayer);
