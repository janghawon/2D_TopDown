...
public class MeshParticleSystem : MonoBehaviour
{
    ...
    public int AddQuad(Vector3 pos, float rot, Vector3 quadSize, bool skwewd, int uvIndex)
    {
        UpdateQuad(_quadIndex, pos, rot, quadSize, skwewd, uvIndex);
    ...
    public void UpdateQuad(int quadIndex, Vector3 pos, float rot, Vector3 quadSize, bool skewd, int uvIndex)
    {
